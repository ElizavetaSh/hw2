...
TEST(INPUT_TEST, file_number_1) { 
    EXPECT_EQ(defin_fsize("hw2/tests/data_test/file_number_2.txt"),14); 
    }

TEST(INPUT_TEST, file_number_2) 
{
    char arr[] = "aabbssddffjjss";
    char *file_values = charsequence_from_file(10, "hw2/tests/data_test/file_number_2.txt");
...
TEST(INPUT_TEST, file_number_3) { 
    EXPECT_EQ(defin_fsize("hw2/tests/data_test/1.txt"), 5558); 
    }
...
TEST(INPUT_TEST, file_number_4) 
{
    ...
    char *file_values_tr = charsequence_from_file(26, "hw2/tests/data_test/test_file.txt");
